...
export class ServerService {
    ...
    ModifyServers(servers: any []){
        const headers = new Headers({ 'Countent-Type':'application/json'});
            return this.http.put('https://udemy-ng-http.firebaseio.com/data',
                servers,
                { headers : headers });
    }
        ...
        .map(
            (response: Response) => {
                ...
                (error: Response) => {
                    ...
                    return Observable.throw('Something wnet wrong');
                }
            )
    }    
    getAppName() {
